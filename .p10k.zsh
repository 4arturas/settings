# Generated by Powerlevel10k configuration wizard on 2021-05-02 at 13:44 EEST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 40036.
# Wizard options: compatible, classic, unicode, lightest, blurred heads, flat tails,
# 2 lines, dotted, left frame, sparse, fluent, transient_prompt, instant_prompt=quiet.
